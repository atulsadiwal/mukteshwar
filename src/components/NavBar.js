...
const NavBar = () => {
    ...
    return (
        <>
            <header
                className={`z-[100] w-full py-4 fixed transition-all ${scrolled ? 'bg-black' : 'bg-white'
                    }`}
            >
                                ...
                                <div className='flex space-x-4'>
                                    {['Home'].map((item) => (
                                        <Link
                                            key={item}
                                            href={`/#`}
                                            className={`text-base font-medium hover:text-blue-500/80 transition-colors ${scrolled ? 'text-white' : 'text-black'
                                                }`}
                                        >
                                            {item}
                                        </Link>
